...
/**
 * A controller for studying Model, ModelMap, ModelAndView 
 * 
 * @author HansKim
 */
@Controller
public class SampleController {
	...
	// VS Model, ModelMap
	// - Model, ModelMap이 데이터를 저장하고 전달하는 위주 인 반면 
	//   ModelAndView는 뷰 이름과 모델 데이터를 한 번에 전달
	...
	@RequestMapping({"/sample01/list6","/sample01/get","/sample01/modify"})
	public void list6() {
