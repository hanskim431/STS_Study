...
//	private static Assembler assembler = new Assembler(); // spring 의 역할을 하는 클래스 spring을 사용한다면 필요가 없다.
	public static ApplicationContext ctx = new GenericXmlApplicationContext("classpath:appCtx.xml"); 
//	public static ApplicationContext ctx = new AnnotationConfigApplicationContext(AppConfig.class); 
