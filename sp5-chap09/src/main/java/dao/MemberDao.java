...
public class MemberDao {
	...
	// MemberDao 생성자
	// 매개변수 DataSource : DB와 연결을 관리하는 객체, 연결에 필요한 정보 갖고있고, DB와 connection pool 관리, connection 제공
	// JdbcTemplate을 사용하려면 DataSource 매개변수로 만들어 JdbcTemplate 객체로 생성해야함.
	public MemberDao(DataSource dataSource) {
		 this.jdbcTemplate = new JdbcTemplate(dataSource);
	}
	
	//RowMapper : 
	// JdbcTemplate에서 헹별로 ResultSet의 행을 맵핑하기 위한 인터페이스.
	//  
//	RowMapper<MemberVO> memberMapper = new RowMapper<MemberVO>() {
//		
//		@Override
